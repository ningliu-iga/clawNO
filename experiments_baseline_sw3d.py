...
def main(args):
    ...
    root = args.results_path + 'grid_%s_n%d_uvh/seed%d_lr%e_wd%e' % (
    ...
    f = open("res_sw3d_%s_%s_n%d_uvh.txt" % (args.model_type, grid_type, args.ntrain), "a")
...
if __name__ == "__main__":
    ...
    if args.hpc_node == 0:
        f = open("res_sw3d_%s_%s_n%d_uvh.txt" % (args.model_type, grid_type, args.ntrain), "w")
        f.write(f'learning_rate, wd, seed, mean epoch time, best epoch, '
                f'train_loss, valid_loss, test_loss\n')
        f.close()
